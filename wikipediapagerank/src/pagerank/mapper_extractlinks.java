...
public class mapper_extractlinks extends Mapper<LongWritable,Text,Text,Text>
	...
	public void map(LongWritable key,Text value,Context context)throws IOException,InterruptedException
	{
		...
		if(recordtype.equals("article"))
		{
			...
			while(matcher.find())
			{
				...
				context.write(new Text(articlename), new Text(outlink));  
